...
Z_FORCEINLINE uint32_t chorba_small_nondestructive_sse41(uint32_t crc, const uint64_t* buf, size_t len) {
    ...
    for(; (i + 256 + 40 + 32 + 32) < len; i += 32) {
        ...
        __m128i chorba45 = _mm_alignr_epi8(chorba56, chorba34, 8);
        __m128i chorba23 = _mm_alignr_epi8(chorba34, chorba12, 8);
        ...
        */
        ...
        __m128i chorba34xor = _mm_xor_si128(chorba34, _mm_bslli_si128(chorba12, 8));
        ...
        */
        ...
        __m128i chorba56xor = _mm_xor_si128(chorba56, _mm_bslli_si128(ab2, 8));
        ...
        */
        ...
        __m128i chorba67 = _mm_alignr_epi8(chorba78, chorba56, 8);
        in3in4 = _mm_xor_si128(in3in4, _mm_xor_si128(chorba67, _mm_bslli_si128(ab2, 8)));
        ...
        */
        ...
        __m128i chorba80 = _mm_bsrli_si128(chorba78, 8);
        ...
        */
        ...
        in3in4 = _mm_xor_si128(in3in4, ab1);
        __m128i a2_ = _mm_bslli_si128(ab2, 8);
        ...
        */
        ...
        __m128i chorb1_ = _mm_bslli_si128(chorba12, 8);
        ...
        */
        ...
        in3in4 = _mm_xor_si128(in3in4, _mm_xor_si128(chorba23, _mm_bslli_si128(ab2, 8)));
        NEXT_ROUND(in3in4, cd1, cd2, cd3, cd4);
        ...
        */
        ///*
        READ_NEXT(input, i, in1in2, in3in4);
        __m128i chorba1_ = _mm_bslli_si128(chorba12, 8);
    ...
    uint8_t* __restrict finalPtr = (uint8_t*)final;

    while (len - i >= sizeof(__m128i)) {
        memcpy(finalPtr, input+(i / sizeof(uint64_t)), sizeof(__m128i));
        i += sizeof(__m128i);
        finalPtr += sizeof(__m128i);
    }

    if (len - i > 0) {
        memcpy(finalPtr, input+(i / sizeof(uint64_t)), len-i);
    }
    ...
    crc = crc32_braid_internal(crc, (uint8_t*) final, rem_len);
...
Z_INTERNAL uint32_t crc32_chorba_sse41(uint32_t crc, const uint8_t *buf, size_t len) {
    ...
    if (algn_diff < len) {
        ...
        if(aligned_len > CHORBA_LARGE_THRESHOLD) {
            ...
            c = chorba_small_nondestructive_sse41(c, aligned_buf, aligned_len);
        } else {
